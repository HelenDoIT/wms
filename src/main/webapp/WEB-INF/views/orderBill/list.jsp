...
<body>
	<s:form id="searchForm" namespace="/" action="orderBill">
		<div id="container">
			<div class="ui_content">
				<div class="ui_text_indent">
					...
					<div id="box_center">
						...
						供应商
						<s:select list="#supplier" listKey="id" listValue="name" name="qo.supplierId"
					...
					<div id="box_bottom">
							...
							<input type="button" value="新增" class="ui_input_btn01 btn_input" data-inputurl="<s:url namespace="/" action="orderBill_input"/>"/>
						</div>
					</div>
				</div>
			</div>
						...
						<tbody>
							<s:iterator value="#pageResult.data">
								<tr>
									...
									<td>
									<s:if test="status==0">
										<s:url action="orderBill_audit" var="auditUrl" escapeAmp="false">
										...
										<s:a namespace="/" action="orderBill_input">
											<s:param name="orderBill.id" value="id"/>编辑</s:a>

										<s:url action="orderBill_delete" var="deleteUrl" escapeAmp="false">
											<s:param name="orderBill.id" value="id"/>
										</s:url>
									...
									<s:else>
										<s:a namespace="/" action="orderBill_view">
											<s:param name="orderBill.id" value="id"/>查看</s:a>
									</s:else>
									</td>
								</tr>
							</s:iterator>
