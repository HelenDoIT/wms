			...
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_bottom">
							<input type="button" value="新增" class="ui_input_btn01 btn_input" data-inputurl="<s:url namespace="/" action="department_input"/>"/>
						</div>
					</div>
				</div>
			</div>
							...
							<s:iterator value="#pageResult.data">
								<tr>
									...
									<td>
										...
										<s:url action="department_delete" var="deleteUrl" >
