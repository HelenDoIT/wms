			...
			<div class="ui_content">
				<div class="ui_text_indent">
					...
					<div id="box_bottom">
							...
							<input type="button" value="新增" class="ui_input_btn01 btn_input" data-inputurl="<s:url namespace="/" action="stockOutcomeBill_input"/>"/>
						</div>
					</div>
				</div>
			</div>
						...
						<tbody>
							<s:iterator value="#pageResult.data">
								<tr>
									...
									<td>
									<s:if test="status==0">
										<s:url action="stockOutcomeBill_audit" var="auditUrl" escapeAmp="false">
										...
										<s:a namespace="/" action="stockOutcomeBill_input">
											<s:param name="stockOutcomeBill.id" value="id"/>编辑</s:a>

										<s:url action="stockOutcomeBill_delete" var="deleteUrl" escapeAmp="false">
											<s:param name="stockOutcomeBill.id" value="id"/>
										</s:url>
									...
									<s:else>
										<s:a namespace="/" action="stockOutcomeBill_view">
											<s:param name="stockOutcomeBill.id" value="id"/>查看</s:a>
									</s:else>
									</td>
								</tr>
							</s:iterator>
