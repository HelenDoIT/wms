		...
		<div class="ui_content">
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<tr>
					...
					<td class="ui_text_lt">
						<s:textfield name="stockOutcomeBill.depot.name" cssClass="ui_input_txt04"></s:textfield>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt" width="140">客户</td>
					<td class="ui_text_lt">
						<s:textfield name="stockOutcomeBill.client.name" cssClass="ui_input_txt04"></s:textfield>
					</td>
				</tr>
				<tr>
					...
					<td class="ui_text_lt">
						...
						<input name="stockOutcomeBill.vdate" class="ui_input_btn02 Wdate" value="<s:property value="#vdate"/>">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>&nbsp;</td>
					<td class="ui_text_lt">
						&nbsp;<input type="submit" value="返回列表" onclick="window.history.back()" class="ui_input_btn01 submit_btn"/>
					</td>
				</tr>
			</table>
		</div>
