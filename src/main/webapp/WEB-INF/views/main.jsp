...
<head>
	...
	<script type="text/javascript" src="/js/plugins/zTree-v3.4/jquery.ztree.all-3.4.min.js"></script>
		 ...
		 <div id="left_menu_cnt">
		 	...
		 	<div id="nav_resource">
		 		<ul id="dleft_tab1" class="ztree">
					<%--显示菜单--%>
					<%--<li><a href="/department.action" target="right">部门管理</a></li>
					<li><a href="/employee.action" target="right">员工管理</a></li>
					<li><a href="/permission.action" target="right">权限管理</a></li>
					<li><a href="/role.action" target="right">角色管理</a></li>
					<li><a href="/systemMenu.action" target="right">系统菜单管理</a></li>--%>
		 		</ul>
		 	</div>
		 </div>
	</div>
