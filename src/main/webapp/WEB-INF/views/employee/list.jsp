				...
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_bottom">
							...
							<input type="button" value="新增" class="ui_input_btn01 btn_input" data-inputurl="<s:url namespace="/" action="employee_input"/>"/>
							<input type="button" value="批量删除" class="ui_input_btn01 btn_batchDelete" data-deleteurl="<s:url namespace="/" action="employee_batchDelete"/>"/>
						</div>
					</div>
				</div>
			</div>
							...
							<s:iterator value="#pageResult.data">
								<tr>
									...
									<td>
										...
										<s:url action="employee_delete" var="deleteUrl">
											<s:param name="employee.id" value="id"/>
										</s:url>
